...
<!--
_header: "Glossaire  - Atelier Partageons l'IA"
-->
...
( - Une introduction pour l'atelier "Partagaons l'IA" - ) 
...
>La __déduction__ consiste à tirer des conclusions spécifiques à partir d’un ensemble de faits et de règles. Les conclusions ainsi trouvées sont donc toujours vraies si les faits et règles sont vrais.
...
* Pour aller plus loin :
    * Voir l'article interne : Méthodes statistiques et modélisation des données
...
Les Tags (@Modele)(@Algorithme) sont communs à cette partie (A1.1)
...
* Pour résoudre des problèmes d'apprentissage automatique (Machine Learning) sur des données structurées, des données tabulées, extraites de base de données relationnelles,  des fichiers excel ou des fichiers de type csv , __les grandes gagnantes des méthodes sont celles du Gragient Boosting__.

Dans cette partie, il est question de découvrir leurs fonctionnements.
...
-->
 ...
 __Les modèles sous-jacents__ :

> * Arbres de décision et Forêts d'arbres de décision
...
-->
 ...
 __Comment se couple les prédictions__ ?
